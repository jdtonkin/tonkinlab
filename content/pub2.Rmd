...
bib_df <- bib2df::bib2df("../assets/pubs/MyPubs.bib", separate_names = FALSE)
...
for (i in 1:length(bib_df) ){
  ...
  #   if( !is.na(bib_df[i,"FILE"]) ){
      pdf_url <- paste0("../assets/pubs/pdfs/",bib_df[i,"BIBTEXKEY"], ".pdf", collapse = "")
      cat(c("  ",'<a href="',pdf_url,'"> <i class="fa fa-fw fa-file-pdf-o"> pdf </i></a>'),
        sep="")
  #   }
  # }

 #      [<i class="fa fa-fw fa-file-pdf-o"></i>]({{ "/assets/pdfs/2018_Tonkin_etal_Nature_Eco_Evo.pdf" | absolute_url }})
